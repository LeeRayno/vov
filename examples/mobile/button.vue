<template>
  <div>
    ...
    <demo-block title="朴素按钮">
      <vov-button
        plain
        type="primary">主题按钮</vov-button>
      <vov-button
        plain
        type="warning">警告按钮</vov-button>
      <vov-button
        plain
        type="danger">危险按钮</vov-button>
      <vov-button
        plain
        type="success">成功按钮</vov-button>
    </demo-block>
    <demo-block title="禁用按钮">
      <vov-button
        disabled
        type="primary"
        @click="handleClick">主题按钮</vov-button>
      <vov-button
        disabled
        type="warning">警告按钮</vov-button>
      <vov-button
    ...
    <demo-block title="按钮大小">
      <vov-button
        size="large"
        @click="handleClick"/>
      <vov-button size="normal"/>
      <vov-button size="small"/>
      <vov-button size="mini"/>
    </demo-block>
  </div>
</template>
